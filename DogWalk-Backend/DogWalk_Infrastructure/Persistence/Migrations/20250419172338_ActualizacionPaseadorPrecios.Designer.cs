...
namespace DogWalk_Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250419172338_ActualizacionPaseadorPrecios")]
    partial class ActualizacionPaseadorPrecios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DogWalk_Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2101),
                        ...
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2107),
                            Nombre = "Usuario",
                            TipoRol = 2
                        },
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2109),
                            Nombre = "Paseador",
                            TipoRol = 3
                        });
                });
            ...
            modelBuilder.Entity("DogWalk_Domain.Entities.Servicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2445),
                        ...
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2450),
                        ...
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2453),
                        ...
                        new
                        {
                            ...
                            CreadoEn = new DateTime(2025, 4, 19, 17, 23, 38, 140, DateTimeKind.Utc).AddTicks(2455),
            ...
            modelBuilder.Entity("DogWalk_Domain.Entities.DetalleFactura", b =>
                {
                    ...
                    b.OwnsOne("DogWalk_Domain.Common.ValueObjects.Dinero", "Subtotal", b1 =>
                        {
                            b1.Property<Guid>("DetalleFacturaId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DogWalk_Domain.Entities.ItemCarrito", b =>
                {
                    ...
                    b.HasOne("DogWalk_Domain.Entities.Servicio", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
